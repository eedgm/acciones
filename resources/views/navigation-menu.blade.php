        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        @endcan
                        @can('view-any', App\Models\Agrupacion::class)
                        <x-dropdown-link href="{{ route('agrupacions.index') }}">
                        Agrupacions
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\Prioridad::class)
                        <x-dropdown-link href="{{ route('prioridads.index') }}">
                        Prioridads
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\Statu::class)
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @endcan
                @can('view-any', App\Models\Agrupacion::class)
                <x-jet-responsive-nav-link href="{{ route('agrupacions.index') }}">
                Agrupacions
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Prioridad::class)
                <x-jet-responsive-nav-link href="{{ route('prioridads.index') }}">
                Prioridads
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Statu::class)
                <x-jet-responsive-nav-link href="{{ route('status.index') }}">
                Status
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\User::class)
